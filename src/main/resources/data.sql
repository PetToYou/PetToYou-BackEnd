...
values (1, 'HOSPITAL', 'H', '101번지 Happy Street Building', 'Happy City', 'Joy District', 'eupmyun', 'Happy Street',
        POINT(126.9780, 37.5665)),
       (2, 'HOSPITAL', 'H', '202번지 Joyful Road Building', 'Joyful City', 'Happy District', 'eupmyun', 'Joyful Road',
        POINT(36.5678, 127.9820));

insert into hospital (store_id, hospital_name, hospital_phone, notice, additional_service_tag, website_link,
                      hospital_info, hospital_info_photo, hospital_status)
values (1, 'Happy Pet Clinic', '0201234567', '9AM to 6PM, Closed on Sundays', 'Parking available, Zero-pay accepted',
        'http://happypetclinic.com', 'Full veterinary services for your beloved pets.',
        'http://happypetclinic.com/photo.jpg', 'ACTIVATE');
...
insert into business_hour (business_hour_id, store_id, store_type, day_of_week, start_time, end_time, break_start_time,
                           break_end_time, is_open)
values (8, 1, 'HOSPITAL', 1, '09:00', '18:00', '12:00', '13:00', true), -- 월요일
       ...
       (7, 1, 'HOSPITAL', 7, '09:00', '15:00', NULL, NULL, true);
-- 일요일, 점심시간 없음
