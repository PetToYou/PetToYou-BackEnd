...
insert into pet (pet_id, member_id, pet_name, species, age, birth, adoption_date, sharing_st, pet_status) values
                                                                                                          (1, 1, 'Buddy', 'Dog', 3, '2021-03-10', '2021-03-20', false, 'ACTIVATE'),
                                                                                                          (2, 2, 'Whiskers', 'Cat', 5, '2019-05-05', '2019-05-15', true, 'ACTIVATE');



insert into store (store_id, DTYPE, store_name, thumbnail_url, store_phone, notice,  website_link, store_info, store_info_photo, store_status, zip_code, address_detail, sido, sigungu, eupmyun, doro, point)
values
    (1, 'H', 'Happy Pet Clinic', 'thumbnail1', '0201234567', '9AM to 6PM, Closed on Sundays', 'http://happypetclinic.com', 'Full veterinary services for your beloved pets.', 'http://happypetclinic.com/photo.jpg', 'ACTIVATE', '58176', 'Happy Street Building', 'Happy City', 'Joy District', 'eupmyun', 'Happy Street', ST_PointFromText("POINT (37.5665 126.9780)",4326) ),
    (2, 'H', 'Joyful Pet Hospital', 'thumbnail 2', '0209876543', '8AM to 5PM, Closed on Saturdays', 'http://joyfulpethospital.com', 'Comprehensive care and wellness programs for your pets.', 'http://joyfulpethospital.com/photo.jpg', 'ACTIVATE', '16791', 'Joyful Road Building', 'Joyful City', 'Happy District', 'eupmyun', 'Anam Street', ST_PointFromText("POINT (37.54814807058306 127.0471094733872)",4326)  );

-- insert into hospital (store_id) values (1), (2);
insert into hospital (store_id, additional_service_tag) values (1, 'Parking available, Zero-pay accepted'), (2, 'Free Wi-Fi, Pet toys available');
...
insert into business_hour (business_hour_id, store_id, store_type, day_of_week, start_time, end_time, break_start_time, break_end_time, open_st) values
                                                                                                                                     (1, 1, 'HOSPITAL', 1, '09:00', '18:00', '12:00', '13:00', true), -- 월요일
