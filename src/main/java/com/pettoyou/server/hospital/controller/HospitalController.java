...
public class HospitalController {
    ...
    // 특정 반경 내의 모든 병원 조회
    @GetMapping()
    public ResponseEntity<ApiResponse<Page<StoreQueryTotalInfo>>> getHospitalList(Pageable pageable, @ModelAttribute HospitalQueryInfo queryInfo){
        Page<StoreQueryTotalInfo> response = hospitalService.getHospitals(pageable, queryInfo);
    ...
    //특정 반경 + 영업 중 인 병원 조회
//    @GetMapping("/main")
//    public ResponseEntity<ApiResponse<Page<StoreQueryTotalInfo>>> getHospitalOpenList(Pageable pageable, @ModelAttribute HospitalQueryInfo queryInfo){
